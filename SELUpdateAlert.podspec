#
#  Be sure to run `pod spec lint SELUpdateAlert.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "tuyongjiang"
  # s.authors            = { "tuyongjiang" => "772304867@qq.com" }
  # s.social_media_url   = "http://twitter.com/tuyongjiang"
